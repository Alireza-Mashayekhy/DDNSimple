  ...
  return (
    <div className="relative">
      ...
      <S.Container>
        ...
        <h1 className="text-right mb-10 px-10 text-4xl">محاسبه کارمزد مدیر</h1>
              ...
              <div className="flex items-center justify-center gap-2 flex-wrap">
                <div className="data-filter-inputs flex justify-center items-center gap-6 w-full flex-wrap">
                  <div className="flex  gap-2 flex-col">
                    <label htmlFor="stockId" className="w-full text-right">
                      عنوان :
                    </label>
                    <S.DropDownStyle
                      options={["نام سهامدار", "کد بورسی", "کد ملی"]}
                      value={selectedType || ""}
                      onChange={(e: { value: string }) => {
                  ...
                  {selectedType === "نام سهامدار" ? (
                    <div className="flex  gap-2 flex-col">
                      <label htmlFor="stockId" className="w-20">
                        نام سهامدار :
                      </label>
                      <S.Input
                        value={lastname}
                    ...
                    <div className="flex  gap-2 flex-col">
                      ...
                      <S.Input
                        ...
                        onChange={(e) => setNationalId(e.value)}
                        placeholder="کد ملی"
                        panelStyle={{
                          background: theme === "dark" ? "black" : "white",
                          color: "red",
                  ...
                  <div className="flex  gap-2 flex-col">
                    ...
                    <S.NumInput
                      value={wage}
                      onValueChange={(e) => setWage(e.value ?? 0)}
                      minFractionDigits={1}
                      maxFractionDigits={1}
                      step={0.5}
                  ...
                  <div className="flex relative gap-2 flex-col">
                    ...
                    <DatePicker
                      ...
                      onChange={(e) => {
                        setStartDate(e.from), setEndDate(e.to);
                      }}
                      inputClass={
                        theme === "dark"
