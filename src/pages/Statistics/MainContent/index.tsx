...
const MainContent: SFC = () => {
  ...
  const handleMainPageDownload = async () => {
    try {
      ...
      link.setAttribute(
        "download",
        `گزارش_تغییرات ${selectedTicker} از تاریخ ${sortedDates[0]} تا تاریخ ${sortedDates[sortedDates.length - 1]}.xlsx`
      );
  ...
  const fetchStatisticsData = async () => {
    ...
    try {
      ...
      const actions = ["change", "new_investor", "exited_investor", "hold"];
      const dates = [];
    ...
    return (
      <div className="change-container">
        <div className="page-header flex flex-col items-center">
          {searchParamsChange.startDate && searchParamsChange.endDate ? (
            <h4>
              {searchParamsChange.startDate} - {searchParamsChange.endDate}
            </h4>
          ) : (
          ...
          {searchParamsChange.ticker && <p>{searchParamsChange.ticker}</p>}
        </div>
        {loadingData ? (
          <div
  ...
  return (
    <div className="relative">
      ...
      <S.Container>
        <h1 className="text-right mb-10 px-10 text-4xl">آمار تغییرات</h1>
        <div className="change-container">
          <div className=" pt-10">
            <div className="data-filter-inputs justify-center flex items-center flex-wrap gap-y-5">
              ...
              <div className="flex flex-col relative">
                ...
                <DatePicker
                  ...
                  range
                  onChange={(e) => {
                    setStartDate(convertToPersianDate(e.from.toISOString()));
                    setEndDate(convertToPersianDate(e.to.toISOString()));
                  }}
                  inputClass={
                    theme === "dark"
            ...
            <div className="flex justify-center items-center mt-8 gap-2 mb-10">
              ...
              />
              <Button
                label={loadingDownload ? "درحال پردازش" : "دانلود گزارش"}
          ...
          >
            ...
            <TabPanel header="آمار ورود سهامدار">
              {renderChangeSubTab("آمار ورود سهامدار", "new_investor")}
            </TabPanel>
            <TabPanel header="آمار خروج سهامدار">
              {renderChangeSubTab("آمار خروج سهامدار", "exited_investor")}
            </TabPanel>
